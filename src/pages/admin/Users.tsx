...
const AdminUsers = () => {
  ...
  const handleVerify = (name: string) => toast.success(`${name} verified`);
                      ...
                      <td className="p-4 text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => handleView(user.name)}>
                              <Eye className="h-4 w-4 mr-2" />
                              View Details
                            </DropdownMenuItem>
                            <DropdownMenuItem onClick={() => handleVerify(user.name)}>
                              <CheckCircle className="h-4 w-4 mr-2" />
                              Verify User
                            </DropdownMenuItem>
                            <DropdownMenuItem className="text-destructive" onClick={() => handleSuspend(user.name)}>
