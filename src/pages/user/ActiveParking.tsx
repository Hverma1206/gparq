  ...
  return (
    <DashboardLayout type="user">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {/* Actions */}
        <div className="space-y-4">
          <Button className="w-full gap-2" size="lg" onClick={handleExtend}>
            <Plus className="h-5 w-5" />
            Extend Parking Time
          </Button>
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="gap-2" onClick={handleNavigate}>
              <Navigation className="h-5 w-5" />
              Navigate to Car
            </Button>
            <Button variant="outline" className="gap-2" onClick={handleSupport}>
